...
function getVideoTitle() {
  const possibleSelectors = ['h1.title.style-scope.ytd-video-primary-info-renderer', 'h1.ytd-watch-metadata', 'h1.title', 'ytd-watch-metadata h1'];
